...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable {
     ...
     */
    function balanceOf(address owner) public view virtual override onlyOwner returns (uint256) {
     ...
     */
    function ownerOf(uint256 tokenId) public view virtual override onlyOwner returns (address) {
